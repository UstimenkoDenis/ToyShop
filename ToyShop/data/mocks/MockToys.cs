        ...
        public IEnumerable<Toy> Toys {
            ...
            get {
                return new List<Toy> {
                    ...
                    new Toy {
                        name = "Слоник",
                        shortDesc = "Каталка на верёвочке.",
                        longDesc = "Слоник - каталка, полностью из дерева. Раскрашен яркими красками, безопасными для детей. К веревочке идет удобная ручка. Расцветки слоников можно подбирать при заказе.",
                        img = "",
                        price = 4500,
                        isFavourite = true,
                        available = true,
